...
public class ListaLivros extends JFrame {
	...
	private static final long serialVersionUID = 1L;
		...
		public ListaLivros() throws ClassNotFoundException, SQLException {
			...
			panel_1.setBounds(65, 11, 386, 303);
			...
			btnNewButtonExibir.setBounds(42, 210, 123, 23);
			...
			btnNewButtonEditar.setBounds(178, 210, 145, 23);
			...
			btnNewButtonRemover.setBounds(155, 244, 137, 23);
		...
		protected void cadastrarLivro() throws ClassNotFoundException, SQLException {
		    ...
		    if (btnNewButtonCadastrar.getText().equals("Editar")) {
