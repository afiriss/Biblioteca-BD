...
public class CadastrarLivro extends JFrame {
	...
	private static final long serialVersionUID = 1L;
		...
		public CadastrarLivro() throws ClassNotFoundException, SQLException {
			...
			panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Cadastrar novo livro", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(255, 255, 255)));
			...
			panel_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Livros dispon\u00EDveis para consulta:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 255, 255)));
			panel_1.setBounds(301, 11, 373, 316);
			contentPane.add(panel_1);
			panel_1.setOpaque(false);
			
			JScrollPane scrollPane = new JScrollPane();
			scrollPane.setBounds(55, 21, 297, 178);
			...
			btnNewButtonEditar.setBounds(207, 210, 145, 23);
			...
			btnNewButtonRemover.setBounds(259, 282, 93, 23);
